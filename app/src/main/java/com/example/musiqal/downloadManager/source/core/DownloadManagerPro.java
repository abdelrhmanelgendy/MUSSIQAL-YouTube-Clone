package com.example.musiqal.downloadManager.source.core;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.example.musiqal.downloadManager.source.Utils.helper.FileUtils;
import com.example.musiqal.downloadManager.source.core.chunkWorker.Moderator;
...
import com.example.musiqal.downloadManager.source.core.mainWorker.AsyncStartDownload;
import com.example.musiqal.downloadManager.source.core.mainWorker.QueueModerator;
import com.example.musiqal.downloadManager.source.database.ChunksDataSource;
import com.example.musiqal.downloadManager.source.database.DatabaseHelper;
import com.example.musiqal.downloadManager.source.database.TasksDataSource;
import com.example.musiqal.downloadManager.source.database.elements.Chunk;
import com.example.musiqal.downloadManager.source.database.elements.Task;
import com.example.musiqal.downloadManager.source.report.ReportStructure;
import com.example.musiqal.downloadManager.source.report.exceptions.QueueDownloadInProgressException;
import com.example.musiqal.downloadManager.source.report.exceptions.QueueDownloadNotStartedException;
import com.example.musiqal.downloadManager.source.report.listener.DownloadManagerListener;
import com.example.musiqal.downloadManager.source.report.listener.DownloadManagerListenerModerator;
