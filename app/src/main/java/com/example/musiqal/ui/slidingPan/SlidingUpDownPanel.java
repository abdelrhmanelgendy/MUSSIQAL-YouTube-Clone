package com.example.musiqal.ui.slidingPan;
...
public class SlidingUpDownPanel extends ViewGroup {

    private static final String TAG = SlidingUpDownPanel.class.getSimpleName();
    ...
    public SlidingUpDownPanel(Context context) {
        this(context, null);
    }

    public SlidingUpDownPanel(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingUpDownPanel(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public float getDirectionalSlideOffset() {
     ...
     * @param listener
     */
    public void setOnPanelSlideListener(PanelSlideListener listener) {
